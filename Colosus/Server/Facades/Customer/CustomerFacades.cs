...
namespace Colosus.Server.Facades.Customer
{
    ...
    {
        public CustomerFacades(IDataConverter dataConverter, IHash hash, IDatabaseOperations operations, IOperationRunner operationRunner, IGuid guid, IMapping mapping)
        {
