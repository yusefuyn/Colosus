...
namespace Colosus.Client.Services.Product
{
    public class ProductService : IProductService
    {
        ...
        public async Task<RequestResult> AddProduct(Entity.Concretes.CreateModel.Product product) =>
        ...
        public async Task<RequestResult> AddStockForProduct(Stock product) =>
